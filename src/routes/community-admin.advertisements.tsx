            ...
            <AnimatedCard key={a.id} className="overflow-hidden border border-warm flex flex-col justify-between">
              <div>
                <div className="h-32 bg-sand relative">
                  {a.image || a.image_url ? (
                    <img src={getImageUrl(a.image || a.image_url)} alt="" className="w-full h-full object-cover" />
                  ) : (
                ...
                <div className="flex gap-2 pt-3 border-t border-warm">
                  ...
                  <button 
                    onClick={() => {
                      ...
                      setImagePreviewUrl(getImageUrl(a.image || a.image_url));
                      setImageFile(null);
...
export const Route = createFileRoute("/community-admin/advertisements")({ component: AdvertisementsPage });
